...
CMyEXEDlg::CMyEXEDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CMyEXEDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CMyEXEDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_CALL_DLL, &CMyEXEDlg::OnBnClickedCallDll)
END_MESSAGE_MAP()
...
void CMyEXEDlg::OnBnClickedCallDll()
{
	Test();
}
